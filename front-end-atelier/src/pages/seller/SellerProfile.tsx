...
export default function SellerProfile() {
  ...
  return (
    <div className="font-sans text-stone-900 text-left space-y-8">
      ...
      {/* Header */}
      <div>
        <h1 className="text-2xl font-display font-light text-stone-950 tracking-tight">Studio Settings Space</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 bg-white border border-stone-200 rounded-3xl p-6 sm:p-8 space-y-6 text-center">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <h3 className="font-display font-medium text-lg leading-tight text-stone-950">{studioName}</h3>
              <p className="text-[10px] text-stone-400 font-mono">OWNED BY: {user?.name.toUpperCase()}</p>
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSaveWorkspaceProfile} className="bg-white p-8 border border-stone-200 rounded-3xl space-y-6">
            ...
            <button
              type="submit"
              className="px-5 py-2.5 bg-stone-950 hover:bg-stone-900 border border-black text-white text-[10px] font-mono font-bold uppercase tracking-widest rounded-lg transition-all flex items-center gap-1.5 cursor-pointer"
            >
