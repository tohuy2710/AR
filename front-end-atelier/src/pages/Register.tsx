...
import { Sofa, KeyRound, Mail, Lock, UserCheck, LayoutDashboard, UserPlus, Sparkles } from 'lucide-react';
...
export default function Register() {
  ...
  const handleRegisterSubmit = (e: React.FormEvent) => {
    ...
    alert(`Success! Registry committed as ${name} (${role === 'seller' ? 'Seller Studio' : 'Customer'})`);
    if (role === 'seller') {
      navigate('/seller');
    } else {
      navigate('/customer');
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="space-y-2 pt-6">
              ...
              <p className="text-stone-400 text-xs font-light leading-relaxed">
                Join our decentralized luxury collective as an elite customer explorer or independent workspace designer.
              </p>
            </div>
          </div>

          <div className="relative z-10 p-5 rounded-2xl bg-stone-950/50 border border-stone-800 space-y-3.5 text-xs">
            <h4 className="font-mono text-[9px] tracking-widest text-[#B39D69] uppercase font-bold">Why Join Atelier?</h4>
            <ul className="space-y-2.5 text-stone-300">
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✔</span>
                <span>Verified certified materials with decadal warrant codes.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✔</span>
                <span>Direct-from-workshop listings for maximum artisan royalty.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✔</span>
        ...
        <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          <div className="space-y-6">
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-4">
              ...
              >
                <span>Commit Registry Agreement</span>
            ...
            <div className="pt-4 border-t border-stone-50 text-center">
              <p className="text-xs text-stone-500">
                ...
                <Link to="/login" className="font-semibold text-stone-950 hover:underline">
                  Sign In Coordinates
                </Link>
              </p>
            </div>
